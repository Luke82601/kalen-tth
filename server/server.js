...
/************************************************************/
  ...
  app.post('/clients', queries.addClient)
  app.post('/contacts/:id', queries.addContact)
  app.get('/clients', queries.getAllCompanies);
  app.get('/contacts/:client_id', queries.getAllContacts)
